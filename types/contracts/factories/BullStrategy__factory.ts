...
import type { BullStrategy, BullStrategyInterface } from "../BullStrategy";
...
export class BullStrategy__factory {
  static readonly abi = _abi;
  static createInterface(): BullStrategyInterface {
    return new utils.Interface(_abi) as BullStrategyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BullStrategy {
    return new Contract(address, _abi, signerOrProvider) as BullStrategy;
  }
}
