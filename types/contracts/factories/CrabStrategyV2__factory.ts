...
export class CrabStrategyV2__factory {
  static readonly abi = _abi;
  static createInterface(): CrabStrategyV2Interface {
    return new utils.Interface(_abi) as CrabStrategyV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CrabStrategyV2 {
    return new Contract(address, _abi, signerOrProvider) as CrabStrategyV2;
  }
}
